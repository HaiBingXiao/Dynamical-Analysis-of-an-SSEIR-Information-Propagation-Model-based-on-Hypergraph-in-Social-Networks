...
public class SIS_BAnetwork_model {
    public static void main(String[] args) {
        ...
        try {
            matrix_2section = readMatrixFromFile("D:\\IDEA\\Hypernetwork_information_model\\output\\BA_adjacencyMatrix.txt");
        ...
        try (FileWriter writer = new FileWriter("D:\\IDEA\\Hypernetwork_information_model\\output\\SIS_BAnetwork_model.txt")) {
