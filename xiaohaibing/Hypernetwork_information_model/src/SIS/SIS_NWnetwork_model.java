...
public class SIS_NWnetwork_model {
    public static void main(String[] args) {
        ...
        try {
            matrix_2section = readMatrixFromFile("D:\\IDEA\\Hypernetwork_information_model\\output\\NW_adjacencyMatrix.txt");
        ...
        try (FileWriter writer = new FileWriter("D:\\IDEA\\Hypernetwork_information_model\\output\\SIS_NWnetwork_model.txt")) {
