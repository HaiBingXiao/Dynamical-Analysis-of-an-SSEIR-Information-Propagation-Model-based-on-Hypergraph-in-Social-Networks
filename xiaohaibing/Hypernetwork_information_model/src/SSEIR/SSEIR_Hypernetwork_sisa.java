...
public class SSEIR_Hypernetwork_sisa {
    public static void main(String[] args) {
        final int NUM_EXPERIMENTS = 50;
        final int NUM_STEPS = 500;
        final String OUTPUT_FILE_PATH = "D:\\桌面\\Hypernetwork_information_model\\SEIIR_output\\SEIIR_Hypernetwork_s_2.txt";
        double[][] cumulativeStateRatios = new double[NUM_STEPS][5];
        double[][] cumulativeStateRatios_a;
        int n; // 节点总数
        double[][] matrix_2section; // 邻接矩阵
        try {
            matrix_2section = readMatrixFromFile("D:\\桌面\\Hypernetwork_information_model\\output\\Hypernetwork_65_2_AdjacencyMatrix.txt");
