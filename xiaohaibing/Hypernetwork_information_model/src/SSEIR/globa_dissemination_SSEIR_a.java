...
public class globa_dissemination_SEIIR_a {
    public static void main(String[] args) {
        ...
        for (double a : A) {
            ...
            OUTPUT_FILE_PATH = "D:\\桌面\\Hypernetwork_information_model\\SEIIR_output\\SEIIR_Hypernetwork_model_a="+a+".txt";
