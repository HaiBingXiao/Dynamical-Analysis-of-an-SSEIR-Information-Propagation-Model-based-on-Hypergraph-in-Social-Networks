...
public class globa_dissemination_SEIIR_p2 {
    public static void main(String[] args) {
        ...
        double v2 = 0.01;
        double v3 = 0.06;
        double[] p = {0.002,0.01,0.05,0.3};
        for (double p2 : p) {
            double[][] cumulativeStateRatios = new double[NUM_STEPS][5];
            OUTPUT_FILE_PATH = "D:\\桌面\\Hypernetwork_information_model\\SEIIR_output\\SEIIR_Hypernetwork_model_p2="+p2+".txt";
