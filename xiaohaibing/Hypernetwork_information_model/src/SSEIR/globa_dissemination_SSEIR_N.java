...
public class globa_dissemination_SEIIR_N {
    public static void main(String[] args) {
        ...
        for (int time = 0; time < 3; time++) {
            if (time == 0) {
                OUTPUT_FILE_PATH = "D:\\桌面\\Hypernetwork_information_model\\SEIIR_output\\SEIIR_Hypernetwork_model_N=1000.txt";
                READ_FILE_PATH = "D:\\桌面\\Hypernetwork_information_model\\output\\Hypernetwork_43_AdjacencyMatrix_1000.txt";
            }
            if (time == 1) {
                OUTPUT_FILE_PATH="D:\\桌面\\Hypernetwork_information_model\\SEIIR_output\\SEIIR_Hypernetwork_model_N=5000.txt";
                READ_FILE_PATH = "D:\\桌面\\Hypernetwork_information_model\\output\\Hypernetwork_43_AdjacencyMatrix_5000.txt";
            }
            if (time == 2) {
                OUTPUT_FILE_PATH="D:\\桌面\\Hypernetwork_information_model\\SEIIR_output\\SEIIR_Hypernetwork_model_N=10000.txt";
                READ_FILE_PATH = "D:\\桌面\\Hypernetwork_information_model\\output\\Hypernetwork_43_AdjacencyMatrix_10000.txt";
            }
