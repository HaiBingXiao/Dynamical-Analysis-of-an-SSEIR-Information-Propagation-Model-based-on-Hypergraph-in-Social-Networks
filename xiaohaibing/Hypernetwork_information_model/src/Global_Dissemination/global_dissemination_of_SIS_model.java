...
public class global_dissemination_of_SIS_model {
    public static void main(String[] args) {
        double b = 0.4;
        double y = 0.06;
        int n1, n2, n3;
        double[][] matrix_AdjacencyMatrixBA, matrix_AdjacencyMatrix65, matrix_AdjacencyMatrix12;
        try {
            matrix_AdjacencyMatrixBA = readMatrixFromFile("D:\\桌面\\Hypernetwork_information_model\\output\\BA_adjacencyMatrix_m=2.txt");
            n1 = matrix_AdjacencyMatrixBA.length;

            matrix_AdjacencyMatrix65 = readMatrixFromFile("D:\\桌面\\Hypernetwork_information_model\\output\\Hypernetwork_65_2_AdjacencyMatrix.txt");
            n2 = matrix_AdjacencyMatrix65.length;

            matrix_AdjacencyMatrix12 = readMatrixFromFile("D:\\桌面\\Hypernetwork_information_model\\output\\Hypernetwork_21_2_AdjacencyMatrix.txt");
            n3 = matrix_AdjacencyMatrix12.length;
        } catch (IOException e) {
            e.printStackTrace();
            return;
        }
        ...
        for (int p = 0; p < 3; p++) {
            ...
            if (p == 0) {
                n = n1;
                xxx = "BA";
                matrix = matrix_AdjacencyMatrixBA;
            } else if (p == 1) {
                n = n2;
                xxx = "Hyper65";
                ...
                n = n3;
                xxx = "Hyper12";
                matrix = matrix_AdjacencyMatrix12;
            }
