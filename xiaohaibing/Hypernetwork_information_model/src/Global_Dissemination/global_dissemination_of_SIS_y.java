...
public class global_dissemination_of_SIS_y {
    public static void main(String[] args) {
        double b = 0.16;
        double[] yy = {0.06, 0.1, 0.2};
        int n43, n65, n87;
        double[][] matrix_AdjacencyMatrix43, matrix_AdjacencyMatrix65, matrix_AdjacencyMatrix87;
        try {
            matrix_AdjacencyMatrix43 = readMatrixFromFile("D:\\桌面\\Hypernetwork_information_model\\output\\Hypernetwork_43_AdjacencyMatrix.txt");
            n43 = matrix_AdjacencyMatrix43.length;
            ...
            n65 = matrix_AdjacencyMatrix65.length;

            matrix_AdjacencyMatrix87 = readMatrixFromFile("D:\\桌面\\Hypernetwork_information_model\\output\\Hypernetwork_87_AdjacencyMatrix.txt");
            n87 = matrix_AdjacencyMatrix87.length;
        } catch (IOException e) {
            e.printStackTrace();
            return;
        }
        ...
        for (int p = 0; p < 3; p++) {
            ...
            for (double y : yy) {
                ...
                try (FileWriter writer = new FileWriter("D:\\桌面\\Hypernetwork_information_model\\output\\global_dissemination_of_SIS_Hypernetwork_" + xxx + "_y=" + y + ".txt")) {
                    for (int k = 0; k < 40; k++) {
