...
public class global_dissemination_of_SIS_b {
    public static void main(String[] args) {
        ...
        for (int p = 0; p < 3; p++) {
            ...
            for (double b : bb) {
                ...
                try (FileWriter writer = new FileWriter("D:\\桌面\\Hypernetwork_information_model\\output\\global_dissemination_of_SIS_Hypernetwork_" + xxx + "_" + b + ".txt")) {
                    for (int k = 0; k < 40; k++) {
