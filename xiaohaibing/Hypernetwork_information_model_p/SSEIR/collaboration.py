...
# 获取所有文件路径
file_paths = glob.glob(r'D:\\桌面\\Hypernetwork_information_model\SSEIR_output1\SEIIR_Hypernetwork_model*.txt')
...
plt.xlabel('Time')
plt.ylabel('Density')
plt.title("(A)   Co-author Network Analysis")
...
# 保存图像为SVG文件
plt.tight_layout()
plt.savefig('D:\\桌面\\Hypernetwork_information_model_p\\photo\\collaboration.svg', format='svg')
